...
interface ISpell {
    ...
    function addLiquidityWStakingRewards(address tokenA, address tokenB, Amounts memory amt, address wstaking)
        external
        payable;
    ...
    function removeLiquidityWStakingRewards(address tokenA, address tokenB, RepayAmounts memory amt, address wstaking)
        external;
